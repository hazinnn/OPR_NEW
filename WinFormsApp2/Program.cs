...
namespace OPR4._2
{
    public partial class Form1 : Form
    {
        ...
        private void InitializeComponent()
        {
            ...
            listBox2.Location = new Point(371, 24);
            listBox2.Margin = new Padding(2);
            listBox2.Name = "listBox2";
            listBox2.Size = new Size(342, 289);
            listBox2.TabIndex = 1;
            // 
            // listBox3
            // 
            ...
            listBox3.Location = new Point(734, 24);
            listBox3.Margin = new Padding(2);
            listBox3.Name = "listBox3";
            listBox3.Size = new Size(313, 289);
            listBox3.TabIndex = 2;
            // 
            // label1
            // 
            ...
            label2.Location = new Point(371, 7);
            ...
            label3.Location = new Point(734, 7);
            ...
            // textBox1
            // 
            textBox1.Location = new Point(1064, 24);
            ...
            // button1
            // 
            button1.Location = new Point(1064, 58);
            ...
            // button2
            // 
            button2.Location = new Point(1064, 84);
            ...
            // button3
            // 
            button3.Location = new Point(1064, 110);
                ...
                using (StreamReader reader = new StreamReader("data.txt"))
                {
                    while (!reader.EndOfStream)
                    {
                        ...
                        if (fields.Length == 3)
                        {
                            ...
                            string sign = fields[1].Trim();
                            DateTime birthDate = DateTime.Parse(fields[2].Trim());
                            ZNAK znak = new ZNAK(name, sign, birthDate);
                            fileZNAKs.Add(znak);

                        }
                        else
                        {
                            MessageBox.Show($"Неверный формат данных в файле. Строка: \"{line}\"");
                        }
                    }
                }


                foreach (var znak in fileZNAKs)
                {
        ...
        private void button3_Click(object sender, EventArgs e)
        {
            ...
            string sign = textBox1.Text.Trim();

            // Проверка на допустимые значения знаков зодиака
            string[] validSigns = { "Овен", "Телец", "Близнецы", "Рак", "Лев", "Дева", "Весы", "Скорпион", "Стрелец", "Козерог", "Водолей", "Рыбы" };
            if (!validSigns.Contains(sign))
            {
                MessageBox.Show($"Неверный знак зодиака: \"{sign}\"");
                return;
            }
        ...
        {
            string[] names = { "Александр", "Иван", "Максим", "Олег", "Павел", "Сергей", "Игорь", "Святослав", "Дмитрий", "Вадим" };
            string[] surnames = { "Иванов", "Петров", "Смирнов", "Васильев", "Козлов", "Лебедев", "Морозов", "Никитин", "Федоров", "Алексеев" };
